...
#define FAN_CHECK_INTERVAL           2  // How often to check that the fan is functional, in seconds
#define FAN_FAIL_COUNT_LIMIT         3
#define FAN_SPEED_REPORT_INTERVAL    1  // How often to report the fan tacho, in seconds
#define TEMPERATURE_CHECK_INTERVAL   1  // How often to check the temperature, in seconds
#define TEMPERATURE_REPORT_INTERVAL  2  // How often to report the temperature, in seconds
...
uint32_t temperature_last_reported = 0;   // How often to report the temperature, in seconds
...
void setup() {
  ...
  Serial.println("Hand heater starting up");
